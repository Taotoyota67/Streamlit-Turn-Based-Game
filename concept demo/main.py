...
if not st.session_state["using_heal"] : # If I have already using heal the previous rerun, the button will be disabled
    # Hit button
...
if skill_act :
    with side_empty1 :
        ...
        for i in range(len("\"Let this divine power be as satisfying nourishment, giving one who has lost their strength the strength to rise again!\"")) :
            time.sleep(0.03)
            st.write("\"Let this divine power be as satisfying nourishment, giving one who has lost their strength the strength to rise again!\""[:i+1])
        time.sleep(2)
    side_empty1.empty()
    st.rerun()
...
if hit_act :
    with side_empty1 :
        ...
        for i in range(len("\"I know things are difficult right now, but I also know you've got what it takes to get through it.\"")) :
            time.sleep(0.03)
            st.write("\"I know things are difficult right now, but I also know you've got what it takes to get through it.\""[:i+1])
        time.sleep(2)
    side_empty1.empty()
